...
/**
 * Every instance of this class is a Noise card (type of Dangerous Sector card).
 * It can be either in your sector or in any sector, and it can also either
 * request that you draw a card or not.
 * 
