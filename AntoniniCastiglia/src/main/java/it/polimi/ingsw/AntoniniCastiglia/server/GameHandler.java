...
public class GameHandler implements Runnable, TimerInterface {
	...
	public synchronized void switchTurn(){
		timer.cancel(); //avoid unuseful switches of turn
	...
	private boolean checkActivePlayers() { //check if the game is still valid, according to the number of players still in
